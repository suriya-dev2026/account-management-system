...
public class PasswordResetRepositoryTest {
    ...
    // @Test
    // public void shouldFindTopByUserIdOrderByCreatedAtDesc() throws
    ...
    // Optional<PasswordReset> result =
    // passwordResetRepository.findTopByUserIdOrderByCreatedAtDesc(user.getId());
    ...
    // Optional<PasswordReset> result =
    // passwordResetRepository.findByResetToken("token123");
    // assertTrue(result.isPresent());
    // }
