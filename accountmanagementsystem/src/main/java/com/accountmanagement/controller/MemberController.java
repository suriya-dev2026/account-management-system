...
public class MemberController {
    ...
    public ResponseEntity<ApiResponse> updateMemberById(@PathVariable UUID id,
        ...
        ApiResponse response = new ApiResponse(AppConstants.SUCCESS, MemberMessage.UPDATE_MEMBER, 201);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<ApiResponse> deleteMemberById(@PathVariable UUID id) {
        ...
        ApiResponse response = new ApiResponse(AppConstants.SUCCESS, MemberMessage.DELETE_MEMBER, 201);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
}
